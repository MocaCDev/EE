/* This JS file exists to customize the header of the webpage to the size of the webpage. */
const header = document.querySelector('[data-name*="header"]');
const header_content = document.querySelector('[data-name*="header-content"]')

/* Check if the webpage is being visited via a mobile device. */
...
window.adjustOnLoad = () => {
    if(window.mobileCheck())
    {
        ...
        switch(header_content.id)
        {
            case "intro-content": header_content.style = "margin-top: 50px";break;
            case "about-intro-header-content": header_content.style = "margin-top: 100px";break;
        }
        /*if(header_content.id === "intro")
            header_content.style = 'margin-top: 20px';*/

        header.classList.remove(intro_name);

        if(header.id === "intro")
        {
            document.getElementById('learn-more').hidden = true;
            header.classList.add('intro-special-4');
            intro_name = 'intro-special-4';
        }
        else { header.classList.add('intro-special-4'); intro_name = 'intro-special-4'; }
    } else
    {
